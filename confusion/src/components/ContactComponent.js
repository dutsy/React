...
class Contact extends Component {
    ...
    handleSubmit(event){
        console.log("currewnt state is " + JSON.stringify(this.state))
        alert("currewnt state is " + JSON.stringify(this.state))
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                value={this.state.telnum} onChange={this.handleInputChange}></Input>
                            </FormGroup>
                            <FormGroup row>
                            ...
                            <FormGroup row>
                                ...
                                rows="12" value={this.state.message} onChange={this.handleInputChange}></Input>
                            </FormGroup>
                           <FormGroup row>
